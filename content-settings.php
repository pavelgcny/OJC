...
Used to mail receipts            </th>
    ...
    <tbody>
        <tr class="webgrid-row-style">
            ...
            <td><input name="chkbox" type="checkbox" disabled="" value="value" checked=""></td>
          <!--  <td><a href="/settings/mailingaddress?clientAddressId=NAAAADAAAAA%3D">Edit</a></td>
            <td><a href="/settings/confirmation/NAAAADAAAAA%3d?type=101">Delete</a></td> -->
        </tr>
    </tbody>
    </table>
<!--	<button class="mr-2 mb-2 btn btn-primary" type="button" onclick="location.href = 'settings/mailingaddress?clientAddressId=0';">Add mailing address</button>
	--><h5 class="form-header">
...
Used to email Statements            </th>
    ...
    <tbody>
        <tr class="webgrid-row-style">
            ...
            <td><input name="chkbox" type="checkbox" disabled="" value="value" checked=""></td>
            <td><input name="chkbox" type="checkbox" disabled="" value="value" checked=""></td>
       <!--     <td><a href="/settings/EmailAddress?clientEmailAddressId=NQAAADkAAAA%3D">Edit</a></td>
            <td><a href="/settings/confirmation/NQAAADkAAAA%3d?type=201">Delete</a></td> -->
        </tr>
    </tbody>
    </table>
<!--	<button class="mr-2 mb-2 btn btn-primary" type="button" onclick="location.href = 'settings/EmailAddress?clientEmailAddressId=0';">Add Email Address</button>
	--> <h5 class="form-header">
   Your Bank Accounts:
    </h5>
	<table class="table table-striped table-bordered">
...
<!--	<button class="mr-2 mb-2 btn btn-primary" type="button" onclick="location.href = 'settings/bankaccount?acctId=0';">Add Bank Account</button>
--> </div>
