<div class="content-w">
        <div id="contentIFirstHome" class="content-i">
        ...
        <div id="contentIHome" class="content-i">
          <div class="content-box">
            <div class="row">
              <div class="col-md-6 col-sm-12">
                <div id="rowHomeFirstLeft" class="row">
                  ...
                  <div class="col-sm-6 col-12 order-1">
                    <div class="element-box">
                      <div class="el-chart-w">
                        ...
                        <canvas height="508" id="donutChart" width="508" class="chartjs-render-monitor" style="display: block; width: 254px; height: 254px;"></canvas>
              ...
              <div class="col-md-6 col-sm-12 order-1 order-sm-2">
                <div class="row">
                  <div class="col-12"><div class="element-wrapper">
                      <div class="element-box">
                        <div class="element-actions">
                        ...
                        <div class="el-chart-w"><div class="chartjs-size-monitor" style="position: absolute; left: 0px; top: 0px; right: 0px; bottom: 0px; overflow: hidden; pointer-events: none; visibility: hidden; z-index: -1;"><div class="chartjs-size-monitor-expand" style="position:absolute;left:0;top:0;right:0;bottom:0;overflow:hidden;pointer-events:none;visibility:hidden;z-index:-1;"><div style="position:absolute;width:1000000px;height:1000000px;left:0;top:0"></div></div><div class="chartjs-size-monitor-shrink" style="position:absolute;left:0;top:0;right:0;bottom:0;overflow:hidden;pointer-events:none;visibility:hidden;z-index:-1;"><div style="position:absolute;width:200%;height:200%;left:0; top:0"></div></div></div>
                          <canvas data-chart-data="13,28,19,24,43,49,40,35,42,46" height="330" id="liteLineChartV2" width="1106" class="chartjs-render-monitor" style="display: block; width: 553px; height: 165px;"></canvas>
                        </div>
                      </div>
                    </div>
  ...
  <div class="element-box">
    ...
    <br>
    <div class="form-desc">Total: <code>15</code> and <code>100.00</code> 
    </div>
  </div>
</div>
</div>
        ...
        <div id="contentI2Home" class="content-i">
            <div class="content-box">
                <div class="element-wrapper">
                    <h6 class="element-header">
                      Recent Donation
                          ...
                          <tbody>
                            <tr>
                              ...
                              <td class="cell-with-media">
                               <span>Tomche Shabbos</span>
                              </td>
                              <td class="text-center">
                                <a class="badge badge-success" href="">Shul</a>
                              </td>
                            ...
                            <tr>
                              ...
                              <td class="text-center">
                                <a class="badge badge-danger" href="">Health</a>
                              </td>
                              <td class="text-right bolder nowrap">
                            ...
                            <tr>
                              ...
                              <td class="cell-with-media">
                               <span>Hatzolah of Flatbush</span>
                              </td>
                              <td class="text-center">
                                <a class="badge badge-warning" href="">Community</a>
                              </td>
                              <td class="text-right bolder nowrap">
                            ...
                            <tr>
                              ...
                              <td class="cell-with-media">
                                <span>Yeshivas Ohr Chadash</span>
                              </td>
                              <td class="text-center">
                                <a class="badge badge-primary" href="">School</a>
                              </td>
                              <td class="text-right bolder nowrap">
                            ...
                            <tr>
                              ...
                              <td class="cell-with-media">
                                <span>Cong Bnei Yisroel</span>
                              </td>
                              <td class="text-center">
                                <a class="badge badge-danger" href="">Shul</a>
                              </td>
                              <td class="text-right bolder nowrap">
                            ...
                            <tr>
                              ...
                              <td class="cell-with-media">
                                <span>Koi Hashem</span>
                              </td>
                              <td class="text-center">
                                <a class="badge badge-primary" href="">Health</a>
                              </td>
                              <td class="text-right bolder nowrap">
